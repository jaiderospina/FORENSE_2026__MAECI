...
* **Modalidad:** Trabajo colaborativo en parejas (Grupos de 2 integrantes).
* **Asignación:** Cada grupo recibirá un (1) documento técnico específico (Estándar ISO, Guía NIST o Manual de Buenas Prácticas) para evitar la duplicidad de temas en el aula.
* **Entregables:**
...
| **G6** | ISO/IEC 17025 | Acreditación y calidad de laboratorios forenses. |

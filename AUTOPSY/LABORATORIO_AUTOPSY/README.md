...
El laboratorio se desarrollará mediante un enfoque de aprendizaje por descubrimiento, también denominado aprendizaje exploratorio. En este modelo, se debe asumir un rol activo en la construcción del conocimiento, mediante la investigación, la experimentación y el análisis de los resultados obtenidos. Este enfoque se alinea con los principios del constructivismo, donde el aprendizaje se genera a partir de la experiencia y la interacción con el contexto de estudio.
...
## Referencias a material autopsy (Útil para el laboratorio)..
